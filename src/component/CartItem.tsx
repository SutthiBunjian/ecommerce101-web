...
const CartItem: React.FC<CartItemProps> =({item})=>{
    ...
    if (!cartContext) {
        throw new Error("CartContext is undefined. Make sure you have wrapped your components with CartProvider.");
    }
        ...
        <div className="w-full min-[150px] flex items-center ">
            ...
            <div className="w-full flex flex-col">
                <div className=" flex justify-between mb-2">
                    ...
                    <div onClick={() => removeFromCart(id)} className="text-xl cursor-pointersor">
