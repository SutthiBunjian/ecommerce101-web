...
const OrderSummaryPopUp: React.FC<OrderSummaryPopUpProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
      <div className="relative my-10 container p-10 w-full h-full max-w-[600px] max-h-[700px] bg-white shadow-md rounded-lg mb-6 overflow-scroll">
        <button
        ...
        <div className="flex flex-col items-center mb-4">
          ...
          <div className="text-lg font-semibold">THANK FOR ORDERING</div>
        </div>
        ...
        <div className=" uppercase font-semibold absolute right-4 bottom-2 p-8">
