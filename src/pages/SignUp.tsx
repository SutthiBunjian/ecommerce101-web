...
function SignUp() {
    const inputStyle = "block w-full py-2.5 px-2 text-sm text-white rounded-xl bg-gray-700 border-gray-300";
                    ...
                    <form className="p-4" onSubmit ={handleSubmit}>
                        ...
                        <div className="p-2 text-white">
                            ...
                            <div className="flex justify-between pt-10">
                                    ...
                                    <button className="bg-blue-400 py-2.5 rounded-2xl w-full ml-1" type="submit" onSubmit={() => {handleSubmit}}>Submit</button>
                                    <button className="bg-blue-400 py-2.5 rounded-2xl w-full ml-1" onClick={() =>navigate("/")} >Cancel</button>
